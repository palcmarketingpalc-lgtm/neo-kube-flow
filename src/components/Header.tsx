    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-background/70 backdrop-blur-lg">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden gap-8 text-sm/6 text-muted-foreground lg:flex">
          ...
          <button
            ...
            className="lg:hidden inline-flex items-center justify-center rounded-lg p-2 text-foreground hover:bg-white/10"
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t border-white/10 bg-card/70">
